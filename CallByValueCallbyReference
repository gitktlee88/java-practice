...
//•	Pass by Reference:
// When we declare a reference type variable, the compiler allocates only space where the memory address of the object can be stored. 
...
// A variable of reference type differs from a variable of a primitive type in the way that a primitive type variable holds the actual data 
// while a reference type variable holds the address of the object which it refers to and not the actual object. 	
